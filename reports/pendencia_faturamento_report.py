...
def generate_pendencia_faturamento_pdf(solicitation_data):
    buffer = io.BytesIO()
    doc = SimpleDocTemplate(
        ...
        subject="Pendência de Faturamento",
        keywords="pendência, faturamento, relatório, empresa"
    )
    ...
    def add_solicitation_section(elements):
        ...
        header_data = [
            [
                ...
                Paragraph("Pendência de Faturamento", title_style)
            ]
        ]
        ...
        elements.append(Spacer(1, 12))
        table_data = [["Código", "Produto / Descrição", "Qtd.", "Separado"]]
        ...
        table = Table(table_data, style=table_style, colWidths=[60, 240, 60, 60])
